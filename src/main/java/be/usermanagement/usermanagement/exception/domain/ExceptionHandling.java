...
public class ExceptionHandling {
    ...
    public static final String METHOD_IS_NOT_ALLOWED = "This request method is not allowed on this end this endpoint. Please send a '%s' request.";
...
//    public static final String PAGE_NOT_FOUND = "This page was not found";
    ...
    public ResponseEntity<HttpResponse> notFoundException(NoResultException noResultException) {
        ...
        return createHttpResponse(NOT_FOUND, noResultException.getMessage());
    }
